...
public partial class App
{
    ...
    public static string GetGridRows(DependencyObject element) => (string)element.GetValue(GridRowsProperty);
    ...
    public static string GetGridColumns(DependencyObject element) => (string)element.GetValue(GridColumnsProperty);
